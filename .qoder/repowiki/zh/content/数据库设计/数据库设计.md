...
## 更新摘要
**所做更改**
- 更新了 verificationTokens 表的复合主键声明语法，从对象语法简化为数组语法
- 修正了复合主键定义的语法格式，提高代码简洁性和可读性
...
**更新** 本次更新反映了项目结构的变化，移除了对国际化专门文档文件的引用，专注于数据库核心设计内容。同时更新了 verificationTokens 表的复合主键声明语法优化。
...
- NextAuth 相关表 accounts/sessions/verification_tokens
  ...
  - verification_tokens：复合主键（identifier+token），采用数组语法定义。
...
**更新** 修正了 verification_tokens 表的复合主键声明语法，从对象语法简化为数组语法，提高代码简洁性和可读性。

**章节来源**
- [schema.ts:28-180](file://src/lib/schema.ts#L28-L180)
