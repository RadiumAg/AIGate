...
- **新增**：glassCardVariants 液体玻璃卡片样式变体系统，支持 default/thin/thick 三种样式
- **新增**：在报表页面中集成 StatSummaryCard 组件，用于展示关键统计数据
- **新增**：增强卡片组件系统，提供统一的液体玻璃视觉效果和交互体验
...
A --> M["全局样式与 Provider<br/>src/app/layout.tsx"]
N["UI 组件库<br/>src/components/ui/*.tsx"] -.-> C
N -.-> D
N -.-> G
N -.-> I
N -.-> K
O["确认对话框系统<br/>src/components/ui/confirm.tsx"] -.-> G
O -.-> I
P["液体玻璃样式增强<br/>AlertDialog/Button"] -.-> N
Q["性能优化<br/>useMemoizedFn/ahooks"] -.-> D
Q -.-> G
Q -.-> I
Q -.-> K
R["服务器端注册模块<br/>src/instrumentation.ts"] -.-> S["管理员用户同步<br/>src/lib/init-admin.ts"]
T["国际化系统<br/>src/i18n/client.tsx"] -.-> U["消息文件<br/>src/messages/*.json"]
V["仪表板国际化<br/>src/components/dashboard-layout/sidebar-*.tsx"] -.-> T
W["登录页面国际化<br/>src/app/login/page.tsx"] -.-> T
X["仪表板页面国际化<br/>src/app/(dashboard)/page.tsx"] -.-> T
Y["统计汇总卡片<br/>src/components/stat-summary-card.tsx"] -.-> N
Z["液体玻璃卡片变体<br/>glassCardVariants"] -.-> Y
```
...
- [src/app/(dashboard)/reports/page.tsx](file://src/app/(dashboard)/reports/page.tsx#L1-L426)
...
SSC["StatSummaryCard<br/>src/components/stat-summary-card.tsx"]
...
- ReportsPage
  ...
  - 参考路径：[src/app/(dashboard)/reports/page.tsx](file://src/app/(dashboard)/reports/page.tsx#L1-L426)
...
- **报表页面**
  ...
  - 参考路径：[src/app/(dashboard)/reports/page.tsx:1-426](file://src/app/(dashboard)/reports/page.tsx#L1-L426)
...
- [src/app/(dashboard)/reports/page.tsx:1-426](file://src/app/(dashboard)/reports/page.tsx#L1-L426)
...
- **性能提升**：在 KeysPage、QuotasPage、UsersPage 和 ReportsPage 中，所有处理函数都使用 useMemoizedFn 包装。
...
- 建议
  ...
  - **新增**：StatSummaryCard 组件支持响应式布局，在小屏幕上自动调整显示方式。
...
- **新增**：性能问题排查
  ...
  - **新增**：检查 StatSummaryCard 组件的渲染性能，确认 memo 化效果。
...
**章节来源**
- [src/components/stat-summary-card.tsx:1-76](file://src/components/stat-summary-card.tsx#L1-L76)
- [src/app/(dashboard)/reports/page.tsx:165-204](file://src/app/(dashboard)/reports/page.tsx#L165-L204)
