...
A --> N["全局样式与 Provider<br/>src/app/layout.tsx"]
O["UI 组件库<br/>src/components/ui/*.tsx"] -.-> C
O -.-> D
O -.-> H
O -.-> J
O -.-> L
P["确认对话框系统<br/>src/components/ui/confirm.tsx"] -.-> H
P -.-> J
Q["Collapsible 组件<br/>src/components/ui/collapsible.tsx"] -.-> G
R["液体玻璃样式增强<br/>AlertDialog/Button"] -.-> O
...
X["仪表板国际化<br/>src/components/dashboard-layout/sidebar-*.tsx"] -.-> V
Y["登录页面国际化<br/>src/app/login/page.tsx"] -.-> V
Z["仪表板页面国际化<br/>src/app/(dashboard)/page.tsx"] -.-> V
AA["调试页面国际化<br/>src/app/(dashboard)/debug/page.tsx"] -.-> V
```
