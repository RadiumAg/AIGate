...
**更新** 本次更新重点关注设置路由器中生产环境安全策略的重大调整，从禁止直接修改环境变量文件改为允许直接修改环境变量文件，这反映了系统在安全策略上的重要变化。
...
- [src/server/api/routers/apiKey.ts](file://src/server/api/routers/apiKey.ts#L1-L464)
- [src/server/api/routers/whitelist.ts](file://src/server/api/routers/whitelist.ts#L1-L191)
...
**更新** 环境变量管理现在允许在生产环境中直接修改，但通过受保护的管理员端点确保只有经过身份验证的用户才能执行此操作。
...
**图表来源**
- [src/auth.ts](file://src/auth.ts#L1-L98)
- [src/server/api/routers/apiKey.ts](file://src/server/api/routers/apiKey.ts#L86-L110)
- [src/server/api/routers/quota.ts](file://src/server/api/routers/quota.ts#L38-L81)
- [src/server/api/routers/whitelist.ts](file://src/server/api/routers/whitelist.ts#L21-L36)
- [src/server/api/routers/dashboard.ts](file://src/server/api/routers/dashboard.ts#L9-L133)
...
- [src/lib/redis.ts](file://src/lib/redis.ts#L1-L49)
- [src/lib/database.ts](file://src/lib/database.ts#L1-L524)
- [src/pages/api/ai/chat/stream.ts](file://src/pages/api/ai/chat/stream.ts#L78-L105)
...
**图表来源**
- [src/server/api/routers/settings.ts](file://src/server/api/routers/settings.ts#L15-L112)
- [deploy.sh](file://deploy.sh#L74-L89)
...
- [src/lib/database.ts](file://src/lib/database.ts#L18-L80)
...
- [src/lib/redis.ts](file://src/lib/redis.ts#L1-L49)
- [src/lib/database.ts](file://src/lib/database.ts#L1-L524)
- [src/lib/schema.ts](file://src/lib/schema.ts#L28-L67)
...
**图表来源**
- [src/server/api/routers/quota.ts](file://src/server/api/routers/quota.ts#L204-L241)
- [src/server/api/routers/apiKey.ts](file://src/server/api/routers/apiKey.ts#L147-L190)
...
- [next.config.ts](file://next.config.ts#L1-L9)
- [src/pages/api/ai/chat/stream.ts](file://src/pages/api/ai/chat/stream.ts#L78-L105)
- [src/auth.ts](file://src/auth.ts#L68-L84)
...
- [src/server/api/routers/whitelist.ts](file://src/server/api/routers/whitelist.ts#L64-L85)
...
**图表来源**
- [src/server/api/routers/ai.ts](file://src/server/api/routers/ai.ts#L87-L193)
- [src/server/api/routers/ai.ts](file://src/server/api/routers/ai.ts#L196-L221)
- [src/server/api/routers/ai.ts](file://src/server/api/routers/ai.ts#L224-L269)
